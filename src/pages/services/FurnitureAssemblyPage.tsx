...
const FurnitureAssemblyPage = () => {
  ...
  useSEO({
    title: "Montador de Móveis na Zona Sul de São Paulo - Montagem Profissional | MAGNVITA",
    description: "Serviços de montagem de móveis em Moema, Brooklin, Campo Belo e região. Montagem planejados, estantes, guarda-roupas. Orçamento grátis: (11) 97748-0538",
